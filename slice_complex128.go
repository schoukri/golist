...
// This file was generated by robots at 2020-04-08 00:01:12.821384 +0000 UTC.
...
func (s *SliceComplex128) At(index int) complex128 {
	if s.data == nil || len(s.data) == 0 {
		panic("SliceComplex128 does not contain any elements")
	}

	if index >= len(s.data) || index < 0 {
		panic(fmt.Sprintf("index %d outside the range of SliceComplex128", index))
	}
...
func (s *SliceComplex128) Clone() *SliceComplex128 {
	...
	s2 := new(SliceComplex128)
	s2.data = make([]complex128, len(s.data))
	copy(s2.data, s.data)
	return s2
}
