...
// This file was generated by robots at 2020-04-08 00:01:14.131591 +0000 UTC.
...
func (s *SliceFloat64) At(index int) float64 {
	if s.data == nil || len(s.data) == 0 {
		panic("SliceFloat64 does not contain any elements")
	}

	if index >= len(s.data) || index < 0 {
		panic(fmt.Sprintf("index %d outside the range of SliceFloat64", index))
	}
...
func (s *SliceFloat64) Clone() *SliceFloat64 {
	...
	s2 := new(SliceFloat64)
	s2.data = make([]float64, len(s.data))
	copy(s2.data, s.data)
	return s2
}
