...
// This file was generated by robots at 2020-04-08 00:13:34.663318 +0000 UTC.
...
func (s *SliceRune) At(index int) rune {
	if s.data == nil || len(s.data) == 0 {
		panic("SliceRune does not contain any elements")
	}

	if index >= len(s.data) || index < 0 {
		panic(fmt.Sprintf("index %d outside the range of SliceRune", index))
	}
